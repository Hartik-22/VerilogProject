...
REM
REM Generated by Vivado on Mon Jun 29 23:43:27 +0530 2026
...
echo "xvlog --incr --relax -prj tb_evm_vlog.prj"
call xvlog  --incr --relax -prj tb_evm_vlog.prj -log xvlog.log
